...
$(function(){
	...
	function initTable() {
		...
		$('#mytable').bootstrapTable({
			...
			url : "/departmentType/getDepartmentTypeList",
	...
	function deleteItems(ids) {
		$.post("/departmentType/deleteDepartmentTypes", {
			ids : ids
		}, function(data) {
	...
	$('#saveBtn').click(function() {
		...
		if($("#editForm").data('bootstrapValidator').isValid()){
    	   $.post("/departmentType/saveDepartmentType", $('#editForm').serialize(), function(data) {
